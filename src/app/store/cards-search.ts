...
// A vendored data table, one row per base letter. The rows run well over the line limit;
// wrapping them would cost the one-row-per-letter shape that makes the table readable, which
// is why max-len exempts regex literals (see eslint.config.js).
